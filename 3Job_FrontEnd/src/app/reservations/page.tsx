...
export default function Reservations(){
    ...
    const [pickupLocation,setPickupLocaiton] = useState<string>('BKK')
    const [returnDate,setReturnDate] = useState<Dayjs|null>(null)
    const [returnLocaiton,setReturnLocation] = useState<string>('BKK')
    ...
    return(
        <main className="w-[100%] flex flex-col items-center space-y-10">
           ...
           <div className="w-fit space-y-2">
                ...
                <LocationDateReserve onDateChange={(value:Dayjs)=>{setPickupDate(value)}} onLocationChange={(value:string)=>{setPickupLocaiton(value)}}/>
           ...
           <button className="block rounded-md bg-sky-600 hover:bg-indigo-600 px-3 py-2 text-white shadow-sm mouse-pointer" onClick={makeReservation}>
